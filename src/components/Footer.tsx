      ...
      <div className="z-10 max-w-[95%] lg:max-w-[90%] mx-auto mb-6">
        <div className="bg-[#FFF5F7] rounded-[30px] px-6 sm:px-8 md:px-12 lg:px-16 pt-10 pb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6 mb-10">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-['DM_Sans'] font-bold text-[#98012E] text-[20px] lg:text-[22px] leading-tight">
                  Aum Metal Alloy
                </h3>
              </div>
              <p className="font-['Sansation'] font-normal text-[#7D7D7D] text-[12px] lg:text-[13px] leading-relaxed">
            ...
            {/* Company Links */}
            <div>
              <h4 className="font-['DM_Sans'] font-bold text-[#98012E] text-[16px] lg:text-[18px] mb-4">
                Company
              </h4>
                ...
                {["Home", "Products", "About", "Grades", "Contact"].map((item) => (
                  <li key={item}>
                    <a
                      ...
                      className="font-['Sansation'] font-normal text-[#A05370] text-[13px] lg:text-[14px] hover:text-[#98012E] transition-colors duration-200"
                    >
                      {item}
                    </a>
                  </li>
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <a
                    ...
                    className="font-['Sansation'] font-normal text-[#A05370] text-[13px] lg:text-[14px] hover:text-[#98012E] transition-colors duration-200 break-all"
                  >
                    aummetalalloy@gmail.com
                  </a>
                </li>
                <li>
                  <p className="font-['Sansation'] font-normal text-[#A05370] text-[13px] lg:text-[14px] leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
            <p className="font-['Sansation'] font-normal text-[#98012E] text-[12px] lg:text-[13px]">
