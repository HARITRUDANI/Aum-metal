      ...
      <div className="w-full px-4 sm:px-6 md:content-padding">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center  mb-1 ">
            <h2 className="font-['DM_Sans'] font-black text-[#98012E] text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] 2xl:text-[82px] mb-3 sm:mb-4 leading-none tracking-normal text-center">
              About Aum Metal Alloy
            </h2>
            <p className="font-['Sansation'] font-normal text-[#7D7D7D] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[24px] max-w-3xl mx-auto leading-[32px] tracking-[0.01em] text-center">
          ...
          {/* Feature Cards Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 mt-14">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-start w-full gap-2.5">
                  {/* Title */}
                  <h3
                    className={`font-['DM_Sans'] font-medium text-[24px] sm:text-[26px] md:text-[28px] lg:text-[32px] leading-none tracking-normal ${
                  ...
                  {/* Description */}
                  <p
                    className={`font-['Sansation'] font-normal text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] leading-[32px] tracking-[0.01em] ${
